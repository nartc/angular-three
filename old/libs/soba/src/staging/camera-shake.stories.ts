import { NgtMathPipeModule, NgtRadianPipeModule, NgtSidePipeModule } from '@angular-three/core';
...
export default {
  ...
  decorators: [
    ...
    moduleMetadata({
      imports: [...setupCanvasModules, NgtSobaCameraShakeModule, DefaultCameraShakeSceneModule],
    }),
  ],
} as Meta;
