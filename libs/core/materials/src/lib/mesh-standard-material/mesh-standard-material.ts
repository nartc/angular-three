...
export class NgtMeshStandardMaterial<TStandardMaterial extends THREE.MeshStandardMaterial = THREE.MeshStandardMaterial> extends NgtCommonMaterial<TStandardMaterial> {
