...
@Component({
    ...
    providers: [
        provideNgtCommonMaterial(NgtMeshToonMaterial),
        provideCommonMaterialRef(NgtMeshToonMaterial)
    ]
})
export class NgtMeshToonMaterial extends NgtCommonMaterial<THREE.MeshToonMaterial> {
    ...
    override get materialType(): AnyConstructor<THREE.MeshToonMaterial> {
