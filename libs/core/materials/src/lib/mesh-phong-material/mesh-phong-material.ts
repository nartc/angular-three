...
@Component({
    ...
    providers: [
        provideNgtCommonMaterial(NgtMeshPhongMaterial),
        provideCommonMaterialRef(NgtMeshPhongMaterial)
    ]
})
export class NgtMeshPhongMaterial extends NgtCommonMaterial<THREE.MeshPhongMaterial> {
    ...
    override get materialType(): AnyConstructor<THREE.MeshPhongMaterial> {
