...
export class NgtLineBasicMaterial<TLineBasicMaterial extends THREE.LineBasicMaterial = THREE.LineBasicMaterial> extends NgtCommonMaterial<TLineBasicMaterial> {
