...
export interface NgtSobaFirstPersonControlsState
    extends NgtInstanceState<FirstPersonControls> {
...
export class NgtSobaFirstPersonControls extends NgtInstance<
    FirstPersonControls,
    NgtSobaFirstPersonControlsState
> {
