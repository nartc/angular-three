...
@Component({
    ...
    template: `
        ...
        >
            <!-- ... -->
            <ngt-physics>
                <!-- 👇 put our Floor inside of ngt-physics -->
                <app-floor></app-floor>
            </ngt-physics>
        </ngt-canvas>
    `,
...
@NgModule({
    imports: [
        /*...*/,
        NgtPhysicsModule,
        // 👇 add NgtPhysicPlaneModule
        NgtPhysicPlaneModule,
        // 👇 add the required modules for the Plane aka our Floor
        NgtMeshModule,
        NgtPlaneGeometryModule,
        NgtShadowMaterialModule
    ],
                            // 👇 declare our FloorComponent
...
@Component({
    ...
    template: `
        ...
        >
            ...
            <ngt-physics>
                <app-floor></app-floor>
                <!-- 👇 put our Cube inside of ngt-physics -->
                <app-cube></app-cube>
            </ngt-physics>
        </ngt-canvas>
    `,
...
@NgModule({
    imports: [
        /*...*/,
        // 👇 add NgtPhysicBoxModule to have access to ngtPhysicBox
        NgtPhysicBoxModule,
        // 👇 required modules for our Cube
