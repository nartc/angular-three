import type { NgtDomEvent, NgtEventManager, NgtEvents, NgtStateGetter, NgtUnknownRecord } from './types';
...
export function createPointerEvents(stateGetter: NgtStateGetter): NgtEventManager<HTMLElement> {
  ...
  return {
    ...
    connected: undefined,
    handlers: Object.keys(DOM_EVENTS).reduce((handlers: NgtUnknownRecord, supportedEventName) => {
