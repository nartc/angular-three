...
export type NgtTail<X extends readonly any[]> = ((...args: X) => any) extends (arg: any, ...rest: infer U) => any
  ? U
  : never;
...
export type NgtUnknownRecord = Record<string, unknown>;
...
export type NgtFilterFunction = (items: THREE.Intersection[], stateGetter: NgtStateGetter) => THREE.Intersection[];
...
export interface NgtBeforeRender<TObject extends THREE.Object3D = THREE.Object3D> {
