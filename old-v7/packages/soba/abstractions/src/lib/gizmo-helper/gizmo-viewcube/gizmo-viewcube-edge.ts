import { make, NgtThreeEvent, NgtTriple, NgtVector3 } from '@angular-three/core';
...
import { NgtSobaGizmoViewcubeInputs, provideNgtSobaViewCubeInputs } from './gizmo-viewcube-inputs';
...
export class NgtSobaGizmoViewcubeEdgeCube extends NgtSobaGizmoViewcubeInputs {
  ...
  get dimensions() {
    return this.getState((s) => s['dimensions']);
  }
