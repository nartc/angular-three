...
import { NgtSobaBounds, NgtSobaBoundsApi, NgtSobaContactShadows } from '@angular-three/soba/staging';
...
@Component({
  ...
  imports: [NgtMesh, NgtObjectPassThrough, NgtValueAttribute, NgtPrimitive, NgIf, AsyncPipe],
})
...
class DefaultBounds {
  ...
  onPointerMissed(event: NgtThreeEvent<PointerEvent>, api: NgtSobaBoundsApi) {
    (event as unknown as NgtUnknownRecord)['button'] === 0 && api.refresh().fit();
  }
}
