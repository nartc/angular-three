      ...
      <div class="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-24">
        <div class="space-y-12">
          <div class="space-y-5 sm:space-y-4 md:max-w-xl lg:max-w-3xl xl:max-w-none">
            <h2 class="text-3xl font-bold text-gray-800 tracking-tight sm:text-4xl">Angular Three Examples</h2>
            <p class="text-xl text-gray-600">
              Here are some example of things you can do with
              <a href="https://github.com/nartc/angular-three/tree/main/apps/sandbox" class="hover:underline">
