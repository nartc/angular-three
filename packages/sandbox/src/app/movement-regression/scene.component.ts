import { extend, injectNgtDestroy, injectNgtRef, injectNgtStore, NgtArgs, NgtPush } from '@angular-three/core';
...
export class YBot {
    ...
    readonly texture = new CanvasTexture(new FlakesTexture(), UVMapping, RepeatWrapping, RepeatWrapping);
...
@Component({
    ...
    template: `
        <ngtp-effect-composer [multisampling]="8">
            <ngtp-ssao [ssaoRef]="ssaoRef" [intensity]="20" [radius]="0.1" [luminanceInfluence]="0" [bias]="0.035" />
...
@Component({
    ...
    template: `
        ...
        <ngts-text text="hello" [color]="'white'" [position]="[0, 0, -0.2]" [fontSize]="0.6" [letterSpacing]="0">
