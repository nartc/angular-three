...
@Directive({
  selector: `
    ...
    ngt-ngt-soba-plane,
    ngt-ngt-soba-box,
    ngt-ngt-soba-cylinder,
    ngt-ngt-soba-cone,
    ngt-ngt-soba-circle,
    ngt-ngt-soba-sphere,
    ngt-ngt-soba-tube,
    ngt-ngt-soba-torus,
    ngt-ngt-soba-tetrahedron,
    ngt-ngt-soba-ring,
    ngt-ngt-soba-polyhedron,
    ngt-ngt-soba-octahedron,
    ngt-ngt-soba-dodecahedron,
    ngt-ngt-soba-icosahedron,
    ngt-ngt-soba-extrude,
    ngt-ngt-soba-lathe,
    ngt-ngt-soba-parametric,
    ngt-ngt-soba-torus-knot,
  `,
