...
import { ATTRIBUTES, removeThreeChild } from '../renderer/utils';
...
//  type: 'compound' | 'portal' | 'three' | 'component';
//
//  element?: Node;
//  injectorFactory?: () => Injector;
//
...
//  }
//
//  queueOperation(op: () => void) {
//    if (this.queueOps) {
//      this.queueOps.add(op);
//    }
//  }
//
//  runQueuedOperations() {
//    if (this.queueOps && this.queueOps.size) {
//      queueMicrotask(() => {
//        this.queueOps?.forEach((op) => op());
//        this.queueOps?.clear();
//      });
//    }
//  }
...
//  readonly commentNodes = new Set<Comment>();
//
//  constructor(private readonly root: NgtRendererRootState) {}
//
...
//    this.commentNodes.add(comment);
//  }
//
//  setCommentParent(comment: Comment, parent: NgtRendererNode) {
//    (comment as NgtAnyRecord)['__ngt_parent__'] = parent;
//  }
//
//  getCommentParent(comment: Comment) {
//    return (comment as NgtAnyRecord)['__ngt_parent__'];
//  }
//
//  isCompound(name: string) {
//    return this.root.compoundPrefixes.some((prefix) => name.startsWith(prefix));
