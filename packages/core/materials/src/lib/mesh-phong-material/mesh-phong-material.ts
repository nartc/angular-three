...
import { NgtInstance, provideInstanceRef, proxify, NgtVector2, NgtObservableInput } from '@angular-three/core';
...
export class NgtMeshPhongMaterial extends THREE.MeshPhongMaterial {
    constructor() {
        super();
    ...
    static ngAcceptInputType_specular: NgtObservableInput<THREE.ColorRepresentation> | undefined;
    static ngAcceptInputType_shininess: NgtObservableInput<number> | undefined;
