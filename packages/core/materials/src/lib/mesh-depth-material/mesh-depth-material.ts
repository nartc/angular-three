...
import { NgtInstance, provideInstanceRef, proxify, NgtObservableInput } from '@angular-three/core';
...
export class NgtMeshDepthMaterial extends THREE.MeshDepthMaterial {
    constructor() {
        super();
    ...
    static ngAcceptInputType_depthPacking: NgtObservableInput<THREE.DepthPackingStrategies> | undefined;
