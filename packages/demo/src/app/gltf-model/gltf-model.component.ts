...
@Component({
  ...
  template: `
    <ngt-canvas [camera]='{position: [1, 1, 2000], fov: 50, near: 0.1, far: 10000}' (created)='$event.gl.setClearColor("grey")'>
      <ngt-orbit-controls></ngt-orbit-controls>

      <ngt-ambient-light o3d [args]='["#ffffff"]'></ngt-ambient-light>

      <ngt-directional-light o3d [args]='["#ffffff", 0.8 * (1 | mathConst:"PI")]'></ngt-directional-light>
