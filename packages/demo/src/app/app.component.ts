...
@Component({
  ...
  template: `
    ...
    <!--      <demo-lods></demo-lods>-->
    <!--    </ngt-canvas>-->
    <!--    <ngt-canvas [linear]="true" (created)="$event.gl.setClearColor('white')">-->
    <!--      <ngt-stats></ngt-stats>-->
    <!--      <ngt-orbitControls-->
    <!--        (animateReady)="onOrbitControlsReady($event)"-->
    <!--      ></ngt-orbitControls>-->
    <!--      <ngt-ambientLight [intensity]="0.5"></ngt-ambientLight>-->
    <!--      <ngt-spotLight [position]="[5, 5, 5]" [intensity]="0.5"></ngt-spotLight>-->
    <!--      <ngt-pointLight [position]="[-10, -10, -10]"></ngt-pointLight>-->
    <!--      <ngt-group (animateReady)="onGroupReady($event)">-->
    <!--        <cube [position]="[2, 0, 0]" [active]="active"></cube>-->
    <!--        <cube [position]="[-2, 0, 0]" [active]="active"></cube>-->
    <!--        <cube [position]="[0, -2, 0]" [active]="active"></cube>-->
    <!--        <cube [position]="[0, 2, 0]" [active]="active"></cube>-->
    <!--        <cube [position]="[2, 2, 0]" [active]="active"></cube>-->
    <!--        <cube [position]="[-2, -2, 0]" [active]="active"></cube>-->
    <!--        <cube [position]="[2, -2, 0]" [active]="active"></cube>-->
    <!--        <cube [position]="[-2, 2, 0]" [active]="active"></cube>-->
    <!--      </ngt-group>-->
