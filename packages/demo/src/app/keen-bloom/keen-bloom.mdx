...
This example demonstrates how `ngt-effect-composer` from `@angular-three/postprocessing` work. `EffectComposer` is a way to add effects to the 3D scene.
...
<Story id="examples-keen-bloom--default" height={480} />
