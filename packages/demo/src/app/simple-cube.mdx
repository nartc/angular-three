This is a fun Cube demo with many things going on:

- The spinning cube with different materials for different faces of the cube
  - Each face will change to different color on hover as well
- Sliders to change the Cube's scale in X, Y, and Z
- A Gizmo component to show the perspective of the cube
- A GUI control to change the Spot Light position
- BoxHelper and SpotLightHelper
