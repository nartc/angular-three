...
This is an example to show how to update OrbitControls target, from both 3D scene and DOM elements.
...
<Story id="examples-orbit-controls-target-switcher--default" height={480} />
