...
export class NgtLineBasicMaterial extends THREE.LineBasicMaterial {
    constructor() {
        super();
    ...
    static ngAcceptInputType_linecap: string| undefined;
    static ngAcceptInputType_linejoin: string| undefined;
