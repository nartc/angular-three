...
All the schematic does is adding the correct dependencies to `package.json`. After the schematic finishes, run `npm install` or `yarn` to install the dependencies.
