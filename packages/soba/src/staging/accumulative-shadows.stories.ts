...
import { NgtsAccumulativeShadows, NgtsEnvironment, NgtsRandomizedLight } from '@angular-three/soba/staging';
...
@Component({
    ...
    `,
    imports: [NgtsAccumulativeShadows, NgtsRandomizedLight, Suzi, NgtsOrbitControls, NgtsEnvironment, NgtArgs],
    schemas: [CUSTOM_ELEMENTS_SCHEMA],
})
