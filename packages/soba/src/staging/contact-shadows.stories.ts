import { createBeforeRenderCallback, NgtArgs, NgtRadianPipe } from '@angular-three/core';
...
import { SobaContactShadows } from '@angular-three/soba/staging';
...
const animate = createBeforeRenderCallback<THREE.Object3D>(({ object, state: { clock } }) => {
...
export const Default: Story = (args) => ({
    props: { ...args, animate },
    template: `
<ngt-mesh [position]="[0, 2, 0]" [beforeRender]="animate">
